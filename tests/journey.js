...
(async () => {
  ...
  await must('١٦هـ · ر٧٢-أ-١ (إعادة البناء من المسودة v2): شبكة المنتقين بالبيانات · صفحة المنتقي بالرأس والشرائح الست · شاشة المدينة · حالة «أنا» · طبقة الشخص بشريطها · الوسم بيد المالك', async () => {
    ...
    ok('١٦هـ · المدينة المختارة تُعرض بالمكان نفسه تحت الشرائح (الرأس والشرائح باقيان · الشريحة تحمل اسمها Paris) · للزائر بلا رأي: لا بطاقة رأي أصلًا (r72p — قرار المالك) · مبدّل Top places · 0 / All places · 3 / Trips · 1 · لا Top places بعد', cty.includes('class="curidn"') && cty.includes('Cities · 1<span class="s">Paris ') && !cty.includes('No notes yet') && !cty.includes('Best time of year') && !cty.includes('class="curfacts"') && cty.includes('Top places · 0') && cty.includes('All places · 3') && cty.includes('Trips · 1') && cty.includes('← Curators') && cty.includes('No top places in Paris yet'), cty.slice(0, 200));
    ...
    ok('١٦هـ · r72p: رأي المدينة يُعرض للزائر (النص · Best time of year · I return = Yes) ولا يعرض الحقول الفارغة (What I love)', ctyN.includes('Coffee first, then the river.') && ctyN.includes('late September') && ctyN.includes('Yes — I keep coming back') && !ctyN.includes('What I love'), ctyN.slice(0, 200));
    ...
    ok('١٦هـ · r72p: Picks بعدده الحقيقي (1) بلا وسم · زر ⚑ برأس صفحة الغير', pk.includes('<b>1</b> picks') && !pk.includes('picks <span class="stage">') && pk.includes("openReport('profile', 'cur_a')"), pk.slice(0, 160));
