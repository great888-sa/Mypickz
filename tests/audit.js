...
const KNOWN_NO_OUTLET = ['follows', 'stats_curators', 'stats_cards', 'followerCount', 'bio', 'contactUrl', 'showFollowerCount', 'displayName', 'verified',
  'favorites']; // ر٥٧+: مجموعة المفضلة المتقاعدة — الكود اقتلع مخارجها (ر٥١) وكتلتها باقية بقواعد ٣٫٨ مع حدثَي favorites_open/favorite_add؛ تُحذف بنشرة تنظيف قادمة (سطر معلَّق بالثامنة v1.5) // ر٥٢ (٣ سبتمبر): قدرات ٣٫٨ الأربع (listBookmarks · tripSaves · bookmarkCount · saveCount) فُتح مخرجها بدفعة كود الأفعال — أزيلت بمرآة الثامنة v1.4 // الوثيقة الدائمة الثامنة — قدرات بُنيت قبل موعدها
