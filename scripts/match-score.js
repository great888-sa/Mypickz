...
const SRC = arg('source', 'overture'), MAX_M = parseInt(arg('max', '300'), 10), MIN = parseFloat(arg('min', '0.45')), CITY = arg('city', '');
...
const STOP = new Set(['restaurant', 'cafe', 'coffee', 'the', 'and', 'de', 'la', 'le', 'du', 'des', 'el', 'al', 'مطعم', 'كافيه', 'كوفي', 'مقهى', 'lounge', 'bar', 'kitchen']);
